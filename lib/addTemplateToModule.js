...
module.exports = function addTemplateToModule(t, toInsert, bps, pragma, pragmaMethod) {
	...
	node.body.splice(index, 0,
		t.VariableDeclaration('var', bps.map((bp, i) =>
			t.VariableDeclarator(t.Identifier('bp' + i),
				t.callExpression(t.memberExpression(t.identifier('Inferno'), t.identifier('createOptBlueprint')), bp)
			)
		))
	);
};
