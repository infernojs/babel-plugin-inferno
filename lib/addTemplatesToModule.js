...
module.exports = function addTemplatesToModule(t, toInsert, templates, pragma) {
		...
		node.body.splice(index, 0,
			t.VariableDeclaration('var', [
				t.VariableDeclarator(t.Identifier('bp' + id),
					t.callExpression(t.memberExpression(t.identifier(pragma || "Inferno"), t.identifier("createBlueprint")), [
						templates[id]
					])
				)
			])
