...
function constructTemplateComponentValue(t, templateElem, elemName, templateFunc, root, parentElem) {
	var typeName;
	var elementName;
...
function constructTemplate(t, templateElem, parentElem, templateFunc, root, parentElemName, level, index) {
	...
	if (parentElem === null) {
		...
		if(templateElem.component) {
			constructTemplateComponentValue(t, templateElem, elemName, templateFunc, root, parentElem);
		} else {
			templateFunc.push(t.variableDeclaration("var", [
				t.variableDeclarator(
					t.identifier(elemName),
