...
var createEmptyTextNodeExpression = "createEmptyText()";
			...
			t.IfStatement(
				...
				t.BlockStatement([
					t.ExpressionStatement(
						t.AssignmentExpression("=", t.identifier(typeName),
							t.ConditionalExpression(
								t.identifier(valueName + ".constructor === Array"),
								t.memberExpression(t.identifier("Inferno"), t.identifier("FragmentValueTypes.LIST_REPLACE")),
								t.memberExpression(t.identifier("Inferno"), t.identifier("FragmentValueTypes.FRAGMENT"))
							)
						)
					)
				])
		...
		templateFunc.push(
			t.IfStatement(
				...
				t.BlockStatement([
					...
					t.ExpressionStatement(t.AssignmentExpression("=", t.identifier(typeName), t.ConditionalExpression(
						t.identifier(valueName + ".constructor === Array"),
						t.memberExpression(t.identifier("Inferno"), t.identifier("FragmentValueTypes.LIST_REPLACE")),
						t.memberExpression(t.identifier("Inferno"), t.identifier("FragmentValueTypes.FRAGMENT"))
					)))
