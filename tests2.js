...
describe('Static ON', function () {
  var babelSettings = {
    presets: [['@babel/preset-env', {modules: false, loose: true, targets: {browsers:'last 1 Chrome versions'}}]],
    plugins: [
      [plugin, {imports: true, defineAllArguments: false, optimizeStaticVNodes: true}],
  ...
  describe('Dynamic children', function () {
      ...
      it('Should add normalize call when there is dynamic and static children mixed', function () {
          expect(transform('<div>{a}<div>1</div></div>')).to.equal('createVNode(1, "div", null, [a, createVNode(513, "div", null, "1", 16)], 0);');
      });

      it('Should not add normalize call when all children are known', function () {
          expect(transform('<div><FooBar/><div>1</div></div>')).to.equal('createVNode(1, "div", null, [createComponentVNode(2, FooBar), createVNode(513, "div", null, "1", 16)], 4);');
      });
      ...
      it('Should create textVNodes when there is single children', function () {
          expect(transform('<div>foobar</div>')).to.equal('createVNode(513, "div", null, "foobar", 16);');
      });

      it('Should create textVNodes when there is single children', function () {
          expect(transform('<div>1</div>')).to.equal('createVNode(513, "div", null, "1", 16);');
      });
      ...
      it('Should mark parent vNode with $HasKeyedChildren if no normalize is needed and all children are keyed', function () {
          expect(transform('<div><FooBar key="foo"/><div key="1">1</div></div>')).to.equal('createVNode(1, "div", null, [createComponentVNode(2, FooBar, null, "foo"), createVNode(513, "div", null, "1", 16, null, "1")], 8);');
      });
  });
  ...
  describe('different types', function () {
      it('Should transform img', function () {
          expect(transform('<img>foobar</img>')).to.equal('createVNode(513, "img", null, "foobar", 16);');
      });

      it('Should transform br', function () {
          expect(transform('<br>foobar</br>')).to.equal('createVNode(513, "br", null, "foobar", 16);');
      });

      it('Should transform media', function () {
          expect(transform('<media>foobar</media>')).to.equal('createVNode(513, "media", null, "foobar", 16);');
      });

      it('Should transform textarea', function () {
          expect(transform('<textarea>foobar</textarea>')).to.equal('createVNode(640, "textarea", null, "foobar", 16);');
      });
  });
  ...
  describe('Special flags', function () {
      ...
      it('Should set hasTextChildren flag and not create textVNode when $HasTextChildren is used ( hardcoded )', function () {
          expect(transform('<div $HasTextChildren>text</div>')).to.equal('createVNode(513, "div", null, "text", 16);');
      });
      ...
      it('Should use optimized text children instead createTextVNode for element single child', function () {
          expect(transform('<div>text</div>')).to.equal('createVNode(513, "div", null, "text", 16);');
      });
  ...
  describe('Basic scenarios', function () {
      it('Should transform div', function () {
          expect(transform('<div></div>')).to.equal('createVNode(513, "div");');
      });
      ...
      it('className should be in third parameter as string when its element', function () {
          expect(transform('<div className="first second">1</div>')).to.equal('createVNode(513, "div", "first second", "1", 16);');
      });
      ...
      it('Should call createVNode twice and text children', function () {
        ...
        <div>single</div>
      </div>`)).to.equal('createVNode(513, "div", null, createVNode(513, "div", null, "single", 16), 2);');
      });
  ...
  describe('contenteditbale', function () {
      it('Should set additional byte on when contenteditbale attribute is found', function () {
          expect(transform('<div contentEditable></div>')).to.eql('createVNode(4609, "div", null, null, 1, {\n  "contentEditable": true\n});');
          expect(transform('<span contenteditable="false"></span>')).to.eql('createVNode(4609, "span", null, null, 1, {\n  "contenteditable": "false"\n});');
          expect(transform('<div contenteditable></div>')).to.eql('createVNode(4609, "div", null, null, 1, {\n  "contenteditable": true\n});');
          expect(transform('<div contentEditable={logic}></div>')).to.eql('createVNode(4097, "div", null, null, 1, {\n  "contentEditable": logic\n});');
          expect(transform('<div contentEditable="true"></div>')).to.eql('createVNode(4609, "div", null, null, 1, {\n  "contentEditable": "true"\n});');
      });
  });
  ...
  describe('defineAllArguments option', function () {
      var babelSettingsPragma = {
          presets: [['@babel/preset-env', {modules: false, loose: true, targets: {browsers:"last 1 Chrome versions"}}]],
          plugins: [
              [plugin, {imports: false, defineAllArguments: true, optimizeStaticVNodes: true}],
              '@babel/plugin-syntax-jsx'
          ]
      };
  ...
  describe('SVG attributes React syntax support', function () {
      it('Should transform xlinkHref to xlink:href', function () {
          expect(transform('<svg><use xlinkHref="#tester"></use></svg>')).to.equal('createVNode(544, "svg", null, createVNode(544, "use", null, null, 1, {\n  "xlink:href": "#tester"\n}), 2);');
      });

      it('Should transform strokeWidth to stroke-width', function () {
          expect(transform('<svg><rect strokeWidth="1px"></rect></svg>')).to.equal('createVNode(544, "svg", null, createVNode(544, "rect", null, null, 1, {\n  "stroke-width": "1px"\n}), 2);');
      });

      it('Should transform strokeWidth to stroke-width', function () {
          expect(transform('<svg><rect fillOpacity="1"></rect></svg>')).to.equal('createVNode(544, "svg", null, createVNode(544, "rect", null, null, 1, {\n  "fill-opacity": "1"\n}), 2);');
      });
  });

  describe('text node and elements mixed', () => {
      it('Should createTextVNode when there are siblings', () => {
          expect(transform('<div>Okay<span>foo</span></div>')).to.eql('createVNode(513, "div", null, [createTextVNode("Okay"), createVNode(513, "span", null, "foo", 16)], 4);');
      });

      // SHORT SYNTAX

      it('Should createTextVNode when text node is under short syntax fragment', () => {
          expect(transform('<>Okay<span>foo</span></>')).to.eql('createFragment([createTextVNode("Okay"), createVNode(513, "span", null, "foo", 16)], 4);');
      });
      ...
      it('Should always short syntax Fragment', () => {
          expect(transform('<><><div>Text</div></></>')).to.eql('createFragment([createFragment([createVNode(513, "div", null, "Text", 16)], 4)], 4);');
      });
      ...
      it('Should handle many dynamic and non dynamic children short syntax', () => {
          expect(transform('<><><span></span>Text{Wohoo}</></>')).to.eql('createFragment([createFragment([createVNode(513, "span"), createTextVNode("Text"), Wohoo], 0)], 4);');
      });
      ...
      it('Should createTextVNode when text node is under large syntax fragment', () => {
          expect(transform('<Fragment>Okay<span>foo</span></Fragment>')).to.eql('createFragment([createTextVNode("Okay"), createVNode(513, "span", null, "foo", 16)], 4);');
      });
      ...
      it('Should always long syntax Fragment', () => {
          expect(transform('<Fragment><Fragment><div>Text</div></Fragment></Fragment>')).to.eql('createFragment([createFragment([createVNode(513, "div", null, "Text", 16)], 4)], 4);');
      });
      ...
      it('Should handle many dynamic and non dynamic children long syntax', () => {
          expect(transform('<Fragment><Fragment><span></span>Text{Wohoo}</Fragment></Fragment>')).to.eql('createFragment([createFragment([createVNode(513, "span"), createTextVNode("Text"), Wohoo], 0)], 4);');
      });
  });
  ...
  describe('Children', function () {
      it('Element Should prefer child element over children props', function () {
          expect(transform('<div children="ab">test</div>')).to.eql('createVNode(513, "div", null, "test", 16);');
      });

      it('Element Should prefer prop over empty children', function () {
          expect(transform('<div children="ab"></div>')).to.eql('createVNode(513, "div", null, "ab", 16);');
      });

      it('Element Should use prop if no children exists', function () {
          expect(transform('<div children="ab"/>')).to.eql('createVNode(513, "div", null, "ab", 16);');
      });
  ...
  describe('Fragments', function () {
      describe('Short syntax', function () {
          ...
          it('Should createFragment keyed children', function () {
              expect(transform('<><span key="ok">kk</span><div key="ok2">ok</div></>')).to.eql('createFragment([createVNode(513, "span", null, "kk", 16, null, "ok"), createVNode(513, "div", null, "ok", 16, null, "ok2")], 8);');
          });

          it('Should createFragment non keyed children', function () {
              expect(transform('<><div>1</div><span>foo</span></>')).to.eql('createFragment([createVNode(513, "div", null, "1", 16), createVNode(513, "span", null, "foo", 16)], 4);');
          });
      });
      ...
      describe('Long syntax', function () {
          describe('Fragment', function () {
              ...
              it('Should createFragment keyed children', function () {
                  expect(transform('<Fragment><span key="ok">kk</span><div key="ok2">ok</div></Fragment>')).to.eql('createFragment([createVNode(513, "span", null, "kk", 16, null, "ok"), createVNode(513, "div", null, "ok", 16, null, "ok2")], 8);');
              });

              it('Should createFragment non keyed children', function () {
                  expect(transform('<Fragment><div>1</div><span>foo</span></Fragment>')).to.eql('createFragment([createVNode(513, "div", null, "1", 16), createVNode(513, "span", null, "foo", 16)], 4);');
              });

              // Long syntax specials
              it('Should createFragment non keyed children', function () {
                  expect(transform('<Fragment key="foo"><div>1</div><span>foo</span></Fragment>')).to.eql('createFragment([createVNode(513, "div", null, "1", 16), createVNode(513, "span", null, "foo", 16)], 4, "foo");');
              });
          ...
          describe('Inferno.Fragment', function () {
              ...
              it('Should createFragment keyed children', function () {
                  expect(transform('<Inferno.Fragment><span key="ok">kk</span><div key="ok2">ok</div></Inferno.Fragment>')).to.eql('createFragment([createVNode(513, "span", null, "kk", 16, null, "ok"), createVNode(513, "div", null, "ok", 16, null, "ok2")], 8);');
              });

              it('Should createFragment non keyed children', function () {
                  expect(transform('<Inferno.Fragment><div>1</div><span>foo</span></Inferno.Fragment>')).to.eql('createFragment([createVNode(513, "div", null, "1", 16), createVNode(513, "span", null, "foo", 16)], 4);');
              });

              // Long syntax specials
              it('Should createFragment non keyed children', function () {
                  expect(transform('<Inferno.Fragment key="foo"><div>1</div><span>foo</span></Inferno.Fragment>')).to.eql('createFragment([createVNode(513, "div", null, "1", 16), createVNode(513, "span", null, "foo", 16)], 4, "foo");');
              });

              it('Should ignore all other props', function () {
                  expect(transform('<Inferno.Fragment abc="foobar" id="test" key="foo"><div>1</div><span>foo</span></Inferno.Fragment>')).to.eql('createFragment([createVNode(513, "div", null, "1", 16), createVNode(513, "span", null, "foo", 16)], 4, "foo");');
              });
          ...
          describe('React.Fragment', function () {
              ...
              it('Should createFragment keyed children', function () {
                  expect(transform('<React.Fragment><span key="ok">kk</span><div key="ok2">ok</div></React.Fragment>')).to.eql('createFragment([createVNode(513, "span", null, "kk", 16, null, "ok"), createVNode(513, "div", null, "ok", 16, null, "ok2")], 8);');
              });

              it('Should createFragment non keyed children', function () {
                  expect(transform('<React.Fragment><div>1</div><span>foo</span></React.Fragment>')).to.eql('createFragment([createVNode(513, "div", null, "1", 16), createVNode(513, "span", null, "foo", 16)], 4);');
              });

              // Long syntax specials
              it('Should createFragment non keyed children', function () {
                  expect(transform('<React.Fragment key="foo"><div>1</div><span>foo</span></React.Fragment>')).to.eql('createFragment([createVNode(513, "div", null, "1", 16), createVNode(513, "span", null, "foo", 16)], 4, "foo");');
              });

              it('Should ignore all other props', function () {
                  expect(transform('<React.Fragment abc="foobar" id="test" key="foo"><div>1</div><span>foo</span></React.Fragment>')).to.eql('createFragment([createVNode(513, "div", null, "1", 16), createVNode(513, "span", null, "foo", 16)], 4, "foo");');
              });
  ...
  describe('automatic optimizations', function () {
    it('Should not add static vNode flag when there is children which cannot be static', function () {
      expect(transform('<div><div>{logic}</div></div>')).to.eql('createVNode(1, "div", null, createVNode(1, "div", null, logic, 0), 2);');
    });

    it('Should mark vNode static when it is manually set', function () {
      expect(transform('<div $IsStatic>{logic}</div>')).to.eql('createVNode(513, "div", null, logic, 0);');
    });

    it('Should mark whole tree static if children which cannot be static is manually marked static', function () {
      expect(transform('<div><div $IsStatic>{logic}</div></div>')).to.eql('createVNode(513, "div", null, createVNode(513, "div", null, logic, 0), 2);');
    });

    it('Should cache static vNode out of context when all children are static', function () {
      expect(transform('var test = function () { return <div><div $IsStatic>{logic}</div></div>; }')).to.eql(
        '\nvar _$C;\n' +
                '\n' +
                'var test = function () {\n' +
                '  return _$C || (_$C = createVNode(513, "div", null, createVNode(513, "div", null, logic, 0), 2));\n' +
            '};');
    });

    it('Should cache single child out of context when root vNode cannot be static', function () {
      expect(transform('var test = function () { return <div><div>{logic}</div><div>1</div></div>; }')).to.eql(
        '\nvar _$C;\n' +
              '\n' +
              'var test = function () {\n' +
              '  return createVNode(1, "div", null, [createVNode(1, "div", null, logic, 0), _$C || (_$C = createVNode(513, "div", null, "1", 16))], 4);\n' +
              '};');
    });

    it('Should cache root vNode out of context when all children can be static', function () {
      expect(transform('var test = function () { return <div><div>a</div><div>b</div></div>; }')).to.eql(
        '\nvar _$C;\n' +
              '\n' +
              'var test = function () {\n' +
              '  return _$C || (_$C = createVNode(513, "div", null, [createVNode(513, "div", null, "a", 16), createVNode(513, "div", null, "b", 16)], 4));\n' +
              '};');
    });

    it('Should cache all children out of context when root cannot be static but all children can be', function () {
      expect(transform('var test = function () { return <div onClick={logic}><div>a</div><div>b</div></div>; }')).to.eql(
        '\nvar _$C;\n' +
          '\n' +
          'var test = function () {\n'+
          '  return createVNode(1, "div", null, _$C || (_$C = [createVNode(513, "div", null, "a", 16), createVNode(513, "div", null, "b", 16)]), 4, {\n' +
          '    "onClick": logic\n' +
          '  });\n' +
          '};'
      );
