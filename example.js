...
function Row({ d, id, selected, deleteFunc, selectFunc }) {
    return (
        <tr className={id === selected ? 'danger' : ''} hasNonKeyedChildren>
            <td className="col-md-1">{id + ''}</td>
            <td className="col-md-4">
                <a defaultValue={{func: selectFunc, id}}>{d.label}</a>
            </td>
            <td className="col-md-1"><a defaultValue={{func: deleteFunc, id}}>{ span }</a></td>
            { td }
        </tr>
    )
}
            ...
            <div className="jumbotron">
                <div className="row">
                    <div className="col-md-6">
                        <h1>Inferno v1.0.0-beta8 - non-keyed</h1>
                    </div>
                    <div className="col-md-6">
                        <div className="row">
